...
\item the document class can also be defined in the document by the CLI: 	 in the template's preamble, write \texttt{documentclass\textbackslash{}{article\textbackslash{}}}.
\end{itemize}
