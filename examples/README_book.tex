...
\addcontentsline{toc}{chapter}{\texttt{md2tex} - a CLI to convert Markdown to TeX}
...
\addcontentsline{toc}{section}{Commands / How to}
...
\addcontentsline{toc}{subsection}{Automated installation (MacOS/GNU-Linux)}
...
\addcontentsline{toc}{subsection}{Manual install}
...
\addcontentsline{toc}{subsection}{Base functionning}
...
\addcontentsline{toc}{subsection}{Arguments and options}
\subsubsection*{Argument}
\addcontentsline{toc}{subsubsection}{Argument}
...
\addcontentsline{toc}{subsubsection}{Optional parameters}
...
\addcontentsline{toc}{subsection}{Command line help}
...
\addcontentsline{toc}{section}{Markdown syntax}
\subsection*{Currently supported}
\addcontentsline{toc}{subsection}{Currently supported}
...
\addcontentsline{toc}{subsection}{Currently unsupported}
...
\addcontentsline{toc}{section}{Things that will mess with the output}
...
\addcontentsline{toc}{section}{About nested lists and visual indentation}
...
\addcontentsline{toc}{subsection}{What is a valid list?}
...
\addcontentsline{toc}{subsection}{Technically, how does it work ?}
...
\addcontentsline{toc}{subsection}{Examples of valid and invalid lists}
\subsubsection*{Valid lists}
\addcontentsline{toc}{subsubsection}{Valid lists}
...
\addcontentsline{toc}{subsubsection}{Invalid lists}
...
\addcontentsline{toc}{section}{License and credits}
