...
\addcontentsline{toc}{section}{\texttt{md2tex} - a CLI to convert Markdown to TeX}
...
\addcontentsline{toc}{subsection}{Commands / How to}
...
\addcontentsline{toc}{subsubsection}{Requirements}
...
\addcontentsline{toc}{subsubsection}{Automated installation (MacOS/GNU-Linux)}
...
\addcontentsline{toc}{subsubsection}{Manual install}
...
\addcontentsline{toc}{subsubsection}{Base functionning}
...
\addcontentsline{toc}{subsubsection}{Arguments and options}
...
\addcontentsline{toc}{subsubsection}{Command line help}
...
\addcontentsline{toc}{subsubsection}{Currently supported}
...
\addcontentsline{toc}{subsubsection}{Currently unsupported}
...
\addcontentsline{toc}{subsection}{Things that will mess with the output}
...
\addcontentsline{toc}{subsection}{About nested lists and visual indentation}
...
\addcontentsline{toc}{subsubsection}{What is a valid list?}
...
\addcontentsline{toc}{subsubsection}{Technically, how does it work ?}
...
\addcontentsline{toc}{subsubsection}{Examples of valid and invalid lists}
...
\addcontentsline{toc}{subsection}{License and credits}
